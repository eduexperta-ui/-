...
export const PERSONAL_INFO = {
    ...
    bio: '학습자 중심의 정교한 LX 설계와 핵심을 파악하는 데이터 분석결과를 바탕으로 개발자 교육의 전 과정을 기획하고 실행합니다. 4개 기수 100% 수료를 이끌어낸 완성도 높은 운영 전문성과 20개가 넘는 교육사업 경험을 바탕으로, 목표에 맞는 체계적인 교육 프로그램을 구축하여 조직의 브랜드 경쟁력과 사회적 책임을 동시에 강화합니다.',
