...
const hackathonSvg = `<svg width="200" height="120" viewBox="0 0 200 120" xmlns="http://www.w3.org/2000/svg"><rect width="200" height="120" rx="8" fill="#18181b"/><path d="M0,100 L200,100 L180,20 L20,20Z" fill="#0c0a09" stroke="#3f3f46"/><rect x="50" y="30" width="100" height="50" fill="#3b82f6" opacity="0.8"/><text x="100" y="60" font-family="sans-serif" font-weight="bold" font-size="18" fill="white" text-anchor="middle">EPSON</text><path d="M70,30 L50,0 M130,30 L150,0" stroke="#f59e0b" stroke-width="3"/><path d="M80,100 V90 L90,80 H110 L120,90 V100" fill="#18181b" stroke="#3f3f46"/><text x="100" y="112" font-family="sans-serif" font-size="10" fill="#a1a1aa" text-anchor="middle">엡손 해커톤 현장</text></svg>`;
const processSvg = `<svg width="200" height="120" viewBox="0 0 200 120" xmlns="http://www.w3.org/2000/svg"><rect width="200" height="120" rx="8" fill="#18181b"/><g transform="translate(20,40)"><path d="M0,10 C20, -10 30,30 50,20 S80,0 100,20" stroke="#52525b" stroke-width="2" fill="none" stroke-dasharray="4 2"/><path d="M100,20 C120,40 140,0 160,10" stroke="#22c55e" stroke-width="3" fill="none"/><circle cx="0" cy="10" r="4" fill="#ef4444"/><circle cx="160" cy="10" r="4" fill="#22c55e"/><text x="80" y="70" font-family="sans-serif" font-size="10" fill="#a1a1aa" text-anchor="middle">프로세스 개선</text></g></svg>`;
const proposalSvg = `<svg width="200" height="120" viewBox="0 0 200 120" xmlns="http://www.w3.org/2000/svg"><rect width="200" height="120" rx="8" fill="#18181b"/><g transform="translate(20,20)"><rect x="0" y="0" width="70" height="80" rx="4" fill="#0c0a09" stroke="#3f3f46"/><text x="35" y="15" font-family="sans-serif" font-size="9" fill="#e4e4e7" text-anchor="middle">B2G 제안</text><path d="M10,25 H60 M10,35 H60 M10,45 H40" stroke="#52525b"/><circle cx="45" cy="65" r="15" fill="#22c55e"/><path d="M38,65 l5,5 l10,-10" stroke="white" stroke-width="2.5" fill="none" stroke-linecap="round"/></g><g transform="translate(100,30)"><rect x="0" y="60" width="20" height="10" fill="#3b82f6"/><rect x="25" y="40" width="20" height="30" fill="#3b82f6"/><rect x="50" y="20" width="20" height="50" fill="#3b82f6"/><rect x="75" y="0" width="20" height="70" fill="#60a5fa"/><path d="M-5,70 H100" stroke="#3f3f46"/></g><text x="100" y="108" font-family="sans-serif" font-size="10" fill="#a1a1aa" text-anchor="middle">비즈니스 임팩트</text></svg>`;
const clevelSvg = `<svg width="200" height="120" viewBox="0 0 200 120" xmlns="http://www.w3.org/2000/svg"><rect width="200" height="120" rx="8" fill="#18181b"/><g transform="translate(100, 60)"><path d="M-50,30 L0,-40 L50,30Z" fill="none" stroke="#f59e0b" stroke-width="2"/><path d="M-30,30 L0,-15 L30,30Z" fill="none" stroke="#f59e0b" opacity="0.6"/><path d="M-80,30 H80" stroke="#3f3f46"/><text y="50" font-family="sans-serif" font-size="10" fill="#a1a1aa" text-anchor="middle">C-Level 리더십</text></g></svg>`;
const marketingSvg = `<svg width="200" height="120" viewBox="0 0 200 120" xmlns="http://www.w3.org/2000/svg"><rect width="200" height="120" rx="8" fill="#18181b"/><g transform="translate(20,20)"><path d="M0,80 L20,60 L40,70 L60,40 L80,50" stroke="#22c55e" stroke-width="2.5" fill="none"/><rect x="0" y="0" width="80" height="80" fill="none" stroke="#3f3f46"/></g><g transform="translate(120,30)"><path d="M0,5 L30,5 L30,0 L50,25 L30,50 L30,45 L0,45Z" fill="#3b82f6"/><text x="25" y="70" font-family="sans-serif" font-size="10" fill="#a1a1aa" text-anchor="middle">마케팅 효율화</text></g></svg>`;
const networkingSvg = `<svg width="200" height="120" viewBox="0 0 200 120" xmlns="http://www.w3.org/2000/svg"><rect width="200" height="120" rx="8" fill="#18181b"/><g transform="translate(100,60)"><circle cx="0" cy="0" r="15" fill="#3b82f6"/><circle cx="-50" cy="-20" r="10" fill="#60a5fa"/><circle cx="50" cy="-20" r="10" fill="#60a5fa"/><circle cx="-30" cy="30" r="10" fill="#60a5fa"/><circle cx="30" cy="30" r="10" fill="#60a5fa"/><path d="M-3,0 L-40,-18 M3,0 L40,-18 M-2,3 L-25,28 M2,3 L25,28" stroke="#52525b"/></g><text x="100" y="108" font-family="sans-serif" font-size="10" fill="#a1a1aa" text-anchor="middle">제로-마케팅 달성</text></svg>`;
const researchSvg = `<svg width="200" height="120" viewBox="0 0 200 120" xmlns="http://www.w3.org/2000/svg"><rect width="200" height="120" rx="8" fill="#18181b"/><g transform="translate(20,20)"><rect x="0" y="0" width="60" height="80" rx="4" fill="#0c0a09" stroke="#3f3f46"/><path d="M10,20 H50 M10,30 H50 M10,40 H30 M10,60 h40" stroke="#52525b" stroke-width="1.5"/><circle cx="30" cy="60" r="5" stroke="#3b82f6" stroke-width="2" fill="none"/></g><g transform="translate(100, 20)"><path d="M10,70 Q40,0 80,70" fill="none" stroke="#60a5fa" stroke-width="2"/><path d="M0,80 H90" stroke="#3f3f46"/></g><text x="100" y="108" font-family="sans-serif" font-size="10" fill="#a1a1aa" text-anchor="middle">학술 연구 및 논문</text></svg>`;
const crowdfundingSvg = `<svg width="200" height="120" viewBox="0 0 200 120" xmlns="http://www.w3.org/2000/svg"><rect width="200" height="120" rx="8" fill="#18181b"/><g transform="translate(20,20)"><path d="M0,80 L80,80 L70,20 L10,20Z" fill="#0c0a09" stroke="#3f3f46"/><text x="40" y="55" font-family="sans-serif" font-weight="bold" font-size="14" fill="#22c55e" text-anchor="middle">264%</text><text x="40" y="70" font-family="sans-serif" font-size="10" fill="#a1a1aa" text-anchor="middle">달성</text></g><g transform="translate(120,30)"><path d="M0,0 L40,20 L0,40Z" fill="#f59e0b"/><text x="20" y="70" font-family="sans-serif" font-size="10" fill="#a1a1aa" text-anchor="middle">와디즈 펀딩</text></g></svg>`;

// SVGs for detail images
const detailPlaceholder1Svg = `<svg width="200" height="120" viewBox="0 0 200 120" xmlns="http://www.w3.org/2000/svg"><rect width="200" height="120" rx="8" fill="#18181b"/><rect x="20" y="20" width="160" height="80" rx="4" fill="#0c0a09" stroke="#3f3f46"/><text x="100" y="70" font-family="sans-serif" font-size="12" fill="#a1a1aa" text-anchor="middle">Detail Image 1</text></svg>`;
const detailPlaceholder2Svg = `<svg width="200" height="120" viewBox="0 0 200 120" xmlns="http://www.w3.org/2000/svg"><rect width="200" height="120" rx="8" fill="#18181b"/><circle cx="100" cy="60" r="40" fill="#0c0a09" stroke="#3f3f46"/><text x="100" y="65" font-family="sans-serif" font-size="12" fill="#a1a1aa" text-anchor="middle">Detail Image 2</text></svg>`;
const detailPlaceholder3Svg = `<svg width="200" height="120" viewBox="0 0 200 120" xmlns="http://www.w3.org/2000/svg"><rect width="200" height="120" rx="8" fill="#18181b"/><path d="M20,100 L100,20 L180,100 Z" fill="#0c0a09" stroke="#3f3f46"/><text x="100" y="80" font-family="sans-serif" font-size="12" fill="#a1a1aa" text-anchor="middle">Detail Image 3</text></svg>`;
...
const hackathonImg = `data:image/svg+xml;base64,${toBase64(hackathonSvg)}`;
const processImg = `data:image/svg+xml;base64,${toBase64(processSvg)}`;
const proposalImg = `data:image/svg+xml;base64,${toBase64(proposalSvg)}`;
const clevelImg = `data:image/svg+xml;base64,${toBase64(clevelSvg)}`;
const marketingImg = `data:image/svg+xml;base64,${toBase64(marketingSvg)}`;
const networkingImg = `data:image/svg+xml;base64,${toBase64(networkingSvg)}`;
const researchImg = `data:image/svg+xml;base64,${toBase64(researchSvg)}`;
const crowdfundingImg = `data:image/svg+xml;base64,${toBase64(crowdfundingSvg)}`;
const detailPlaceholder1Img = `data:image/svg+xml;base64,${toBase64(detailPlaceholder1Svg)}`;
const detailPlaceholder2Img = `data:image/svg+xml;base64,${toBase64(detailPlaceholder2Svg)}`;
const detailPlaceholder3Img = `data:image/svg+xml;base64,${toBase64(detailPlaceholder3Svg)}`;


// SVG Icons as React Components
export const Icons = {
    curriculum: <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" /></svg>,
    lx_design: <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" /></svg>,
    ...
    leadership: <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg>,
    data_analysis: <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></svg>,
    agile: <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M4 4v5h5M20 20v-5h-5M4 4l16 16" /></svg>,
...
export const PERSONAL_INFO = {
    name: '김태진',
    title_line1: '잠재력을 성장으로 이끌어내는',
    title_line2: 'IT 교육 전문가',
    bio: '학습자 중심의 교육 설계, 교육 데이터 분석, 프로젝트 관리 역량을 발휘하여 개발자 성장을 위한 여정을 기획하고 실행합니다. 이를 통해 교육 니즈에 맞는 체계적인 프로그램을 운영하여 조직의 실무역량 강화에 기여합니다.',
    email: '000@gmail.com',
    phone: '010-0000-0000',
};
